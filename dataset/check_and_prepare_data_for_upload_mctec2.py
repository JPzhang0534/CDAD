...
from dataset.utils_mvtec2 import (
    DIRECTORY_STRUCTURE,
    SubmissionException,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "submission_path",
        type=str,
        default='/home/data/zjp/code/VGDiffZero/results/clip/mvtec2/submission_folder/',
        help=(
    ...
    args.submission_path = "/home/data/zjp/code/VGDiffZero/results/clip/mvtec2/submission_folder/"
