...
from model.huggingface_clip_surgery.hf_clip_loader import load
model, processor = load(path='/home/data/zjp/code/bridge/lyf/VGDiffZero-main/pre-trained_model/CLIP/CLIP-vit-large-14', is_surgery=True)
image_path= '/home/data/zjp/dataset/coco2014/images/train2014/COCO_train2014_000000581282.jpg'
import PIL
img = PIL.Image.open(image_path)
inputs = processor(text=['people in left'],images=[img], return_tensors='pt',padding=True).to("cuda")
