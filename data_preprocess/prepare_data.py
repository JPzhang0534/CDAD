...
parser.add_argument('--data-folder',default='/home/data/zjp/dataset/VisA/', type=str,help='the path to downloaded VisA dataset')
parser.add_argument('--save-folder',default='/home/data/zjp/dataset/VisA_pytorch/', type=str,help='the target path to save the reorganized VisA dataset facilitating data loading in pytorch')
parser.add_argument('--split-file',default='/home/data/zjp/dataset/VisA/split_csv/1cls.csv', type=str,help='the csv file to split downloaded VisA dataset')
